...
class Corn(farmArea: FarmArea) : FarmCropBase(farmArea) {
    override val growDuringTextures: Map<Int, Texture> = mapOf(
        0 to Texture.createImageTexture(ResourcesEnum.CORN_GROW_0.inputStream),
        1 to Texture.createImageTexture(ResourcesEnum.CORN_GROW_1.inputStream),
        2 to Texture.createImageTexture(ResourcesEnum.CORN_GROW_2.inputStream),
        3 to Texture.createImageTexture(ResourcesEnum.CORN_GROW_3.inputStream),
        4 to Texture.createImageTexture(ResourcesEnum.CORN_GROW_4.inputStream),
        5 to Texture.createImageTexture(ResourcesEnum.CORN_GROW_5.inputStream),
